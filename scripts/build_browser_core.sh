...
mkdir -p browser_python/engine browser_python/mcts browser_python/agents
...
zip -r ../frontend/public/blokus_core.zip engine/ mcts/ agents/ worker_bridge.py -x "*/__pycache__/*" "*.pyc"
